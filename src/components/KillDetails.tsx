...
export function KillDetails(props: PropsType) {
  ...
  return (
    <>
      {event && (
        <div className="w-[98%] h-[auto] self-center bg-white bg-opacity-90 flex flex-col">
          ...
          <div className="grid grid-cols-[1fr_0.5fr_1fr] grid-rows-1 gap-2 py-3 px-5 w-[80%] min-w-[850px] max-w-[1100px] self-center">
            <EquipmentInfo
              type="killer"
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-black text-[1rem] font-bold mt-4">DATE</p>
